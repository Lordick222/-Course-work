...
RUSRobot::RUSRobot(std::string name,						//Builder 
	std::string power,
	std::string gun,
	std::string caliber,
	std::string walk,
...
RUSRobot::RUSRobot(const RUSRobot &tank) :
...
void RUSRobot::EnterRobot() {
	std::cout << "\tEnter Robot of RUS army\n\t";
	setName();			std::cout << "\t";
	setPower();			std::cout << "\t";
	setGun();			std::cout << "\t";
...
void RUSRobot::OutRobot() {
	std::cout << "\n\t";
	std::cout << "RUS Robot : \t\t\t\t" << getName() << "\n\t";
